...
- **Frontend**: React + TypeScript with molstar for 3D visualization
...
- molstar 3D viewer with dynamic sizing (smaller, centered)
...
- molstar may require additional browser permissions for 3D rendering
