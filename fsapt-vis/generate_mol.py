...
# Export to XYZ
# qcelemental to_string('xyz') includes the number of atoms and comment line
xyz_str = mol.to_string('xyz')

with open('public/default.xyz', 'w') as f:
    f.write(xyz_str)

print("Generated public/default.xyz")
