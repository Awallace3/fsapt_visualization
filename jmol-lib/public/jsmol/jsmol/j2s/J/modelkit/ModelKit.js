...
Clazz.load (["JU.BS", "$.P3", "J.i18n.GT"], "J.modelkit.ModelKit", ["java.lang.Boolean", "$.Float", "$.IllegalArgumentException", "java.util.Arrays", "$.Hashtable", "JU.AU", "$.Lst", "$.Measure", "$.P4", "$.PT", "$.SB", "$.V3", "JM.Atom", "$.ModelSet", "JS.SV", "JU.BSUtil", "$.Edge", "$.Elements", "$.Escape", "$.Logger", "$.SimpleUnitCell", "JV.Viewer"], function () {
...
if ((n = this.moveConstrained (iatom, p, !isOccSet)) == 0 || Float.isNaN (p.x) || !isOccSet) {
return n;
}for (var i = bsOcc.nextSetBit (0); i >= 0; i = bsOcc.nextSetBit (i + 1)) {
