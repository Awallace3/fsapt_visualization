...
Clazz.load (["J.adapter.writers.XtlWriter", "J.api.JmolWriter"], "J.adapter.writers.PWMATWriter", ["java.lang.Float", "JU.P3", "$.PT", "JU.Logger"], function () {
...
}, J.adapter.writers, "PWMATWriter", J.adapter.writers.XtlWriter, J.api.JmolWriter);
...
this.bs = (this.isSlab ? bs : this.uc.removeDuplicates (this.vwr.ms, bs));
