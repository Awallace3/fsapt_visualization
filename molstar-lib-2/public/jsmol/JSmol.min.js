...
m=l[d];a._Loader._checkLoad&&C(c,d,k);if(!m||m.claxxOwner===c&&m.funParams==k)return h.funParams=k,h.claxxOwner=c,h.exClazz=c,l[d]=h;var q=null,s=m.stacks;s||(s=[],q=m,m.claxxOwner&&(s[0]=q.claxxOwner));if(!m.stacks||m.claxxReference!==c){++P;m=function(){var c;a:{var d=arguments.callee.claxxReference,j=arguments.callee.methodName;c=arguments;fx=this[j];var h=a.getParamsType(c);if(!fx)try{System.out.println(a.getStackTrace(5))}catch(n){}if(e){var r=d.__CLASS_NAME__+" "+j+" ";0>V.indexOf(r)&&(V+=r+
"\n");e[r]||(e[r]=0);e[r]++}if(fx.lastParams==h.typeString&&fx.lastClaxxRef===d){if(h.hasCastedNull){d=[];for(j=0;j<c.length;j++)d[j]=c[j]instanceof a.CastedNull?null:c[j]}else d=c;c=fx.lastMethod?fx.lastMethod.apply(this,d):null}else{fx.lastParams=h.typeString;fx.lastClaxxRef=d;r=fx.stacks;r||(r=d.prototype[j].stacks);for(var k=!1,l=r.length;0<=--l;)if(k||r[l]===d){var m=r[l].prototype[j],z=h,k=c,q=fx,s=[],t=!0,E=void 0;for(E in m)if(92==E.charCodeAt(0)){var u=E.substring(1).split("\\");u.length==
z.length&&s.push(u);t=!1}else if(t&&"funParams"==E&&m.funParams){E=m.funParams;u=E.substring(1).split("\\");u.length==z.length&&(s[0]=u);break}E=void 0;if(!(E=0==s.length)){E=void 0;for(var E=[],O=s.length,u=0;u<O;u++){for(var x=[],xa=!0,C=s[u].length,B=0;B<C;B++)if(x[B]=a.getInheritedLevel(z[B],s[u][B]),0>x[B]){xa=!1;break}xa&&(x[z.length]=u,E.push(x))}if(0==E.length)E=null;else{O=E[0];for(u=1;u<E.length;u++){x=!0;for(B=0;B<z.length;B++)if(O[B]<E[u][B]){x=!1;break}x&&(O=E[u])}E=s[O[z.length]].join("\\")}E=
!(s=E)}if(E)k=new b;else{m=t?m:m["\\"+s];t=null;if(z.hasCastedNull){t=[];for(z=0;z<k.length;z++)t[z]=k[z]instanceof a.CastedNull?null:k[z]}else t=k;q.lastMethod=m;k=m.apply(this,t)}if(!(k instanceof b)){c=k;break a}k=!0}"construct"!=j&&fb(this,d,j,h.typeString);c=void 0}}return c};m.methodName=d;m.claxxReference=c;m=l[d]=m;d=[];for(l=0;l<s.length;l++)d[l]=s[l];m.stacks=d}s=m.stacks;0>rb(s,c)&&s.push(c);q&&(q.claxxOwner===c?(m[q.funParams]=q,q.claxxOwner=null,q.funParams=null):q.claxxOwner||(m["\\unknown"]=
...
D[f]||(D[f]=c));break;case "swt":a="org.eclipse.swt";break;case "ajax":a="net.sf.j2s.ajax";break;case "j2s":a="net.sf.j2s";break;default:a.lastIndexOf(".*")==a.length-2&&(a=a.substring(0,a.length-2))}c&&(D["@"+a]=c);d&&!j&&!window[a+".registered"]?(L++,"java"==a&&(a="core"),b.loadClass(a+".package",function(){0==--L&&da()},!0,!0,1)):e&&e()}};a.loadClass=function(c,d,e){self.Class||(Class=a,Class.forName=a._4Name,JavaObject=a._O);return c&&b.loadClass(c,d,!0,e,1)};b.loadClass=function(c,f,h,k,l){l||
(l=0);null==k&&(k=!1);if("boolean"==typeof f)return a.evalType(c);null!=window["java.registered"]&&!D["@java"]&&b.loadPackage("java");b.keepOnLoading=!0;if(!h&&(L&&c.lastIndexOf(".package")!=c.length-8||0!=c.indexOf("java.")&&!isClassDefined(ea)))Ja.push([c,f]),System.out.println("loadclass-queuing"+c+ea+" "+isClassDefined(ea));else if((l=isClassDefined(c))||N["@"+c]){if(l&&f&&(h=G(c),!h||h.status>=x.STATUS_LOAD_COMPLETE))k?window.setTimeout(f,25):f()}else{var m=b.getClasspathFor(c);l=e[m];if(!l)for(k=
H.length;0<=--k;)if(H[k].path==m||H[k].name==c){l=!0;break}if(l){if(f&&(l=G(c)))if(l.onLoaded){if(f!=l.onLoaded){var r=l.onLoaded,q=f;l.onLoaded=function(){r();q()}}}else l.onLoaded=f}else{l=a.unloadedClasses[c]&&G(c)||new x;l.name=c;l.path=m;l.isPackage=m.lastIndexOf("package.js")==m.length-10;Z(m,c,l);l.onLoaded=f;l.status=x.STATUS_KNOWN;c=!1;for(k=H.length;0<=--k;)if(H[k].status!=x.STATUS_LOAD_COMPLETE){c=!0;break}if(l.isPackage){for(k=H.length;0<=--k&&!H[k].isPackage;)H[k+1]=H[k];H[++k]=l}else c&&
...
b.binaryFolders&&b.binaryFolders.length?b.binaryFolders[0]:"j2s");f=(h.lastIndexOf("/")==h.length-1?h:h+"/")+(d?"":c.lastIndexOf("/*")==c.length-2?c.substring(0,k+1):c+(!e?".js":"."!=e.charAt(0)?"."+e:e))}return f};b.ignore=function(){var a=1==arguments.length&&arguments[0]instanceof Array?a=arguments[0]:null,b=a?a.length:arguments.length;if(!a)for(var a=Array(b),c=0;c<b;c++)a[c]=arguments[c];C(a);for(c=0;c<b;c++)N["@"+a[c]]=1};b.onScriptLoading=function(){};b.onScriptLoaded=function(){};b.onScriptInitialized=
function(){};b.onScriptCompleted=function(){};b.onClassUnloaded=function(){};b.onGlobalLoaded=function(){};b.keepOnLoading=!0;var S={},N={},U=function(c,d,e,f){if(!f)try{eval(e+";//# sourceURL="+c)}catch(h){if(a._isQuiet)return;c="[Java2Script] The required class file \n\n"+c+(0==e.indexOf("[Exception")&&e.indexOf("data: no")?"\nwas not found.\n":"\ncould not be loaded. Script error: "+h.message+" \n\ndata:\n\n"+e)+"\n\n"+a.getStackTrace();alert(c);a.alert(c);throw h;}b.onScriptLoaded(c,!1);sa(d)},
...
d;k&&alert("WHY>>");k=e[d];e[d]=!0;Ya(H,d);K=!0;ra=!1;b._checkLoad&&System.out.println("\t"+d+(f?"\n -- required by "+f:"")+"  ajax="+K+" async="+ra);f=d;a._debugging&&(d=d.replace(/\.z\.js/,".js"));k||System.out.println("loadScript "+d);b.onScriptLoading(d);if(K&&!ra){var r=m._getFileData(d);try{U(d,f,r,k)}catch(q){alert(q+" loading file "+d+" "+c.name+" "+a.getStackTrace())}l&&l()}else c={dataType:"script",async:!0,type:"GET",url:d,success:ca(d,!1,l),error:ca(d,!0,l)},h++,k?setTimeout(c.success,
...
!1;r=document.getElementsByTagName("SCRIPT");for(q=0;q<r.length;q++)if(s){if(r[q].onreadystatechange&&r[q].onreadystatechange.path==l.path&&"interactive"==r[q].readyState){m=!0;break}}else if(r[q].onload&&r[q].onload.path==l.path){m=!0;break}m||(l.status=x.STATUS_CONTENT_LOADED,updateNode(l))}if(b.keepOnLoading){q=!0;if(m=Ia(x.STATUS_KNOWN))for(R(m);h<k&&(m=Ia(x.STATUS_KNOWN));)R(m);else if(0!=H.length)m=H.shift(),!e[m.path]||0!=H.length||!ha||m.musts.length||m.optionals.length?(Ha(d,m,!0),W(m,m.path,
m.requiredBy,!1)):ha&&(ha=!1);else if(m=F(x.STATUS_KNOWN))for(R(m);h<k&&(m=F(x.STATUS_KNOWN));)R(m);else q=!1;if(!(q||0<h)){l=[Ia,F];r=null;for(q=0;2>q;q++)for(;m=l[q](x.STATUS_CONTENT_LOADED);)1==q&&r===m&&(m.status=x.STATUS_LOAD_COMPLETE),updateNode(m),r=m;for(;!(ma=[],!na(d,c)););for(q=0;2>q;q++)for(r=null;(m=l[q](x.STATUS_DECLARED))&&r!==m;)updateNode(r=m);r=[];for(q=0;2>q;q++)for(;m=l[q](x.STATUS_DECLARED);)r.push(m),m.status=x.STATUS_LOAD_COMPLETE;if(r.length){for(q=0;q<r.length;q++)Ba(r[q]);
...
(b._classCountOK=0),System.out.println("Loading class "+c));h=S["#"+c];h||(h=(h=G(c))?h:new x,h.name=c,h.path=D["#"+c]||"unknown",Z(h.path,c,h),h.status=x.STATUS_KNOWN,Ha(d,h,!1));ja(h,a,!0);5==arguments.length&&f&&(f.status=h.status,f.clazzList=arguments[4]);if(h.declaration=f)h.status=x.STATUS_CONTENT_LOADED;ja(h,e,!1)}},ja=function(a,b,c){if(b&&b.length){C(b);for(var d=0;d<b.length;d++){var e=b[d];if(e&&!isClassDefined(e)&&!N["@"+e]){var f=G(e);f||(f=new x,f.name=e,f.status=x.STATUS_KNOWN);f.requiredBy=
a;Ha(a,f,c)}}}};window.Clazz?a.load=Q:b.load=Q;var Z=function(a,b,c){var d="@"+a;if(a=S[d])if(a instanceof Array){for(var d=!1,e=0;e<a.length;e++)if(a[e].name==b){d=!0;break}d||a.push(c)}else S[d]=[a,c];else S[d]=c;S["#"+b]=c},R=function(a){var c=a.name;if(!isClassDefined(c)&&!N["@"+c]){var d=b.getClasspathFor(c);a.path=d;Z(d,c,a);if(!e[d])return W(a,d,a.requiredBy,!1),!0}return!1},ea=b.runtimeKeyClass="java.lang.String",Ja=[];b.getJ2SLibBase=function(){var a=window["j2s.lib"];return a?a.base+("."==
a.alias?"":(a.alias?a.alias:a.version?a.version:"1.0.0")+"/"):null};var ra=!0,K=!1,Y=-1;b.MODE_SCRIPT=4;b.MODE_XHR=2;b.MODE_SYNC=1;b.setLoadingMode=function(a,c){var d=!0,e=!0;"string"==typeof a?(a=a.toLowerCase(),0<=a.indexOf("script")?e=!1:a.indexOf("async"),d=!1):a&b.MODE_SCRIPT?e=!1:d=!(a&b.MODE_SYNC);K=e;Y=(ra=d)&&0<=c?c:-1;return d};var da=function(){if(!L&&isClassDefined(ea)){for(var a=Ja,c=0;c<a.length;c++)b.loadClass(a[c][0],a[c][1]);Ja=[]}};b.loadZJar=function(a,c){var d=null,e=c instanceof
Array;e?c=c[c.length-1]:d=c==ea?da:null;b.jarClasspath(a,e?c:[c]);b.loadClass(c,d,!0)};var Da={},Oa=[],Ha=function(a,b,c){var e=!1;c?(c=a.musts,b.requiredBy||(b.requiredBy=a)):c=a.optionals;Da[b.name]||(Oa.push(b),Da[b.name]=b);for(var f=0;f<c.length;f++)if(c[f].name==b.name){e=!0;break}e||(c.push(b),ha&&(0!=b.name.indexOf("java")&&0!=b.name.indexOf("net.sf.j2s.ajax"))&&(ga&&(ha=!1),ga=!0));a:{if(a.name&&a!=d&&a!=b)for(e=0;e<b.parents.length;e++)if(b.parents[e].name==a.name)break a;b.parents.push(a)}},
Ba=function(a){var b=a.parents;if(b)for(var c=b.length;0<=--c;)Ya(b[c].musts,a)||Ya(b[c].optionals,a)};a.binaryFolders=b.binaryFolders=[b.getJ2SLibBase()]})(a,a._Loader);a._LoaderProgressMonitor={};var W=a._LoaderProgressMonitor,H=null,ga=0,N=null,ua=0;W.DEFAULT_OPACITY=m&&m._j2sLoadMonitorOpacity?m._j2sLoadMonitorOpacity:55;W.hideMonitor=function(){N.style.display="none"};W.showStatus=function(a,b){if(!N){var c=document.createElement("DIV");c.id="_Loader-status";c.style.cssText="position:absolute;bottom:4px;left:4px;padding:2px 8px;z-index:"+
(window["j2s.lib"].monitorZIndex||1E4)+";background-color:#8e0000;color:yellow;font-family:Arial, sans-serif;font-size:10pt;white-space:nowrap;";c.onmouseover=ub;N=c;document.body.appendChild(c);wa||(wa=!0)}jb(N);if(null==a)b?na():W.hideMonitor();else{N.appendChild(document.createTextNode(""+a));"none"==N.style.display&&(N.style.display="");kb(W.DEFAULT_OPACITY);var d,c=navigator.userAgent;d=document.body;var e=d.parentNode,h=e.clientHeight;d=d.scrollTop+d.offsetTop;var k=e.scrollTop+e.offsetTop,
...
"red")};X.err.println=function(a){B.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n","red")};X.err.write=function(a,b,c){X.err.print(String.instantialize(a).substring(b,b+c))}}(Clazz,Jmol))};Jmol.___JmolDate="$Date: 2022-04-28 22:41:57 -0500 (Thu, 28 Apr 2022) $";Jmol.___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";Jmol.___JmolVersion="14.32.54";
